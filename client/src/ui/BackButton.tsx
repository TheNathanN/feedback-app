...
const BackButton = ({ color }: Props) => {
  const basicStyling = 'text-h4 font-bold py-3 px-7 rounded-md flex items-center justify-center hover:underline transition-all cursor-pointer '
